    ...
    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-200">
      ...
      <div className="flex justify-between items-start mb-3">
        <div className="flex-1">
          ...
          <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium ${statusConfig.bgColor} ${statusConfig.color} border border-slate-200 dark:border-slate-600`}>
